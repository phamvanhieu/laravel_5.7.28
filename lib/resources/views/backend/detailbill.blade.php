			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<p>Thời Gian Đặt Hàng: {{date( "H:i:s d/m/Y ",strtotime($customer->created_at))}}</p>
					</div>
						...
						<table class="table table-bordered" style="margin-top:20px;">				
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <td><?php
                                    $pro_id = $item->pro_id;
                                    echo $product_name = App\Product::find($pro_id)->name;
                                    $product_img = App\Product::find($pro_id)->image;
                                    ?></td>
